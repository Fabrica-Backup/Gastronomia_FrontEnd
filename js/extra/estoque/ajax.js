...
$.getJSON('../js/testeJson.js', function (jsonObjectIngrediente) {
    jsonIngrediente = jsonObjectIngrediente;

    // get da tabela de unidades
    $.getJSON('../js/testeJsonUnidade.js', function (jsonObjectUnidade) {
        ...
        $.each(jsonObjectIngrediente, function (indexIngrediente, valIngrediente) {
